...
func (r *UsersRepositoryPostgres) Insert(user models.NewUser) (id int, err error) {
...
func (r UsersRepositoryPostgres) GetByID(id int) (user models.User, err error) {
...
func (r UsersRepositoryPostgres) GetPassword(authLogin models.AuthLogin) (string, error) {
